inherited frmCadastroAlunos: TfrmCadastroAlunos
  ...
  inherited pnCentralCadastro: TPanel
    ...
    inherited pnBotoes: TPanel
      ...
      inherited lbTitulo: TLabel
        Width = 285
        Caption = 'Cadastro/Matr'#237'cula de Alunos'
        ExplicitWidth = 285
      end
    end
  end
  ...
  object pnAddDisciplinas: TPanel [4]
    Left = 131
    Top = 219
    Width = 431
    Height = 345
  ...
  object cdsAlunoDisc: TClientDataSet
    PersistDataPacket.Data = {
      5D0000009619E0BD0100000018000000030000000000030000005D0007496441
      6C756E6F04000100000000000C49644469736369706C696E6104000100000000
      000944657363726963616F010049000000010005574944544802000200320000
      00}
    Active = True
    Aggregates = <>
    FieldDefs = <
